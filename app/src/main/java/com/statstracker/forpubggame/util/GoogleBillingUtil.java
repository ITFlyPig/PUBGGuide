...
public class GoogleBillingUtil {
    ...
    public static String[] SUB_IDS = new String[]{"pubg_statstracker_vip_1month"};
    public String[] inAppSKUS = new String[]{};//内购ID,必填
    public String[] subsSKUS = new String[]{"pubg_statstracker_vip_1month"};//订阅ID,必填
    ...
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public GoogleBillingUtil build() {
        if (mBillingClient == null) {
            synchronized (mGoogleBillingUtil) {
                Log.d("tt", "BaseApplication.getInstance(): " + PubgApplication.getInstance());
                if (mBillingClient == null) {
                    if (isGooglePlayServicesAvailable(PubgApplication.getInstance())) {
                        builder = BillingClient.newBuilder(PubgApplication.getInstance());
